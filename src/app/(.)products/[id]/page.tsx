...
const ProductDialog = () => {
  ...
  // const product: ProductTyping = await fetch(`https://fakestoreapi.com/products/${id}`)
  //   .then(result => result.json())
  ...
  return (
    ...
    <Dialog.Root defaultOpen onOpenChange={() => router.push('/')}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="lg:flex fixed top-[18%] left-[50%] z-[1000] max-h-[85vh] w-[90vw] 
          max-w-[750px] translate-x-[-50%]  rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
          {
            product.image && (
          ...
          <div className=''>
            ...
            {/* buttons */}
            <div className='mt-[30px] space-y-2 flex items-center flex-col'>
